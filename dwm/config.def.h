...
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_beige, col_black, col_black },
	[SchemeSel]  = { col_beige, col_black,  col_beige  },
};
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_black, "-nf", col_beige, "-sb", col_beige, "-sf", col_black, NULL };
...
static const Key keys[] = {
	...
	{ MODKEY,			XK_w,  spawn,	   SHCMD("/usr/bin/librewolf") },
